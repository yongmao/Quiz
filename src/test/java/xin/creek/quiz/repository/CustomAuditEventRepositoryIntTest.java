package xin.creek.quiz.repository;

import xin.creek.quiz.QuizApp;
import xin.creek.quiz.config.Constants;
import xin.creek.quiz.config.audit.AuditEventConverter;
import xin.creek.quiz.domain.PersistentAuditEvent;
...
import static xin.creek.quiz.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
